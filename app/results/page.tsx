...
export default function ResultsPage() {
  ...
  const content = {
    ...
    normal: {
      ...
      description:
        "Tu IMC está en el rango saludable. Continúa con tus hábitos actuales de alimentación y ejercicio.",
    ...
    overweight: {
      ...
      description:
        "Tu IMC indica sobrepeso. Considera adoptar hábitos más saludables de alimentación y ejercicio.",
      image: "/placeholder.svg?height=300&width=400",
  ...
  const pdfData: PDFData = {
    ...
    classification:
      currentBMIData?.classification ||
      bmiCategory?.replaceAll("-", " ") ||
      "Normal",
      ...
      <div className="relative z-10 mx-auto max-w-2xl">
        ...
        <div className="flex items-center justify-between mb-6 animate-in fade-in slide-in-from-top-3 duration-500">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-500">
              {isPlaying ? "Reproduciendo" : "Audio reproducido"}
            </span>
          </div>
        </div>
        ...
        >
          <CardHeader className="pb-4 relative z-10">
            ...
            <CardTitle
              className={`mb-1 text-xl font-bold ${colors.text} flex items-center gap-2`}
            >
              {content.title}
          ...
          <CardContent className="space-y-6 relative z-10">
            ...
            <div className="bg-white/70 p-4 rounded-lg space-y-4">
              ...
              <div className="h-2 rounded bg-slate-200 overflow-hidden mt-4">
                <div
                  className={`h-full transition-all duration-500 ${
                    isHealthyWeight ? "bg-green-500" : "bg-slate-900"
                  }`}
              ...
              <p className="text-xs text-slate-500 mt-2">
                Peso ideal (IMC 18.5–24.9): {idealWeight.min.toFixed(1)} –
                {idealWeight.max.toFixed(1)} {weightUnit}
              </p>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-3">
                  <div className="flex items-center gap-2 text-green-800">
                    ...
                    <span className="text-sm font-medium">
                      ¡Felicitaciones! Tu peso está en el rango saludable.
                    </span>
                  </div>
